...
const Selection = ({
  ...
  return (
    <button
      type="button"
      className="flex min-w-[90px] items-center justify-center rounded-md border border-gray-300 px-3 py-1 text-xs shadow-sm hover:border-gray-400 hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-brand"
      onClick={onClick}
