...
export const useRegisterReactPDFFont = () => {
  useEffect(() => {
    // Arial is the default PDF font in app settings, but Arial font files are
    // not bundled in this repository. Register it to a bundled sans fallback
    // to prevent runtime "Font family not registered" failures.
    Font.register({
      family: "Arial",
      fonts: [
