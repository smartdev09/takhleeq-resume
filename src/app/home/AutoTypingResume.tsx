        ...
        <ResumePDF
          ...
          settings={{
            ...
            formToHeading: {
              ...
              certifications: resume.certifications[0]?.name
                ? "CERTIFICATIONS"
                : "",
              awards: resume.awards[0]?.title ? "AWARDS & SCHOLARSHIPS" : "",
              publications: resume.publications[0]?.title ? "PUBLICATIONS" : "",
              volunteering: resume.volunteering[0]?.organization
                ? "VOLUNTEERING & LEADERSHIP"
                : "",
              interests: (resume.interests.commaSeparated ?? "").trim()
                ? "INTERESTS"
                : "",
