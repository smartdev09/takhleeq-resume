...
export const END_HOME_RESUME: Resume = {
  ...
  publications: [],
  volunteering: [],
  interests: deepClone(initialInterest),
  custom: {
    descriptions: [],
  },
};
...
export const START_HOME_RESUME: Resume = {
  ...
  certifications: [deepClone(initialCertification)],
  awards: [deepClone(initialAward)],
  publications: [deepClone(initialPublication)],
  volunteering: [deepClone(initialVolunteering)],
  interests: deepClone(initialInterest),
  custom: {
    descriptions: [],
  },
